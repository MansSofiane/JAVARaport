...
$objPHPExcel->getActiveSheet()->setCellValue('T'.$j, $row_v['pt']);$tpt=$tpt+$row_g['pt'];
$objPHPExcel->getActiveSheet()->setCellValue('U'.$j, $row_v['mtt_reg']);$tmtt_reg=$tmtt_reg+$row_g['mtt_reg'];
$objPHPExcel->getActiveSheet()->setCellValue('V'.$j, $row_v['mtt_solde']);$tmtt_solde=$tmtt_solde+$row_g['mtt_solde'];
