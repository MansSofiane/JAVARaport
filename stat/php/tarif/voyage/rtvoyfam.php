...
if (isset($_REQUEST['row']) && isset($_REQUEST['row1']) && isset($_REQUEST['row2']) && isset($_REQUEST['row3']) && isset($_REQUEST['row4'])&& isset($_REQUEST['tsous'])) {
    $jour = mysql_escape_string($_REQUEST['row']);
    $nbpf = mysql_escape_string($_REQUEST['row1']);
    $opt = mysql_escape_string($_REQUEST['row2']);
    $zone = mysql_escape_string($_REQUEST['row3']);
    $age = mysql_escape_string($_REQUEST['row4']);
